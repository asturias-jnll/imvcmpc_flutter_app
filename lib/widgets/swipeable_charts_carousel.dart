...
class SwipeableChartsCarousel extends StatefulWidget {
  const SwipeableChartsCarousel({super.key});

  @override
  State<SwipeableChartsCarousel> createState() =>
      _SwipeableChartsCarouselState();
}

class _SwipeableChartsCarouselState extends State<SwipeableChartsCarousel> {
